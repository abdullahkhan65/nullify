    ...
    <>
      ...
      <section className="mx-auto w-full max-w-6xl px-6 py-20">
        <Reveal>
          ...
          <p className="mx-auto mt-3 max-w-xl text-center text-zinc-400">
            The full walkthrough — carriers, compliance, edge cases — lives on the{" "}
        ...
        <div className="mt-14 grid gap-10 sm:grid-cols-3">
          {steps.map((step, i) => (
            <Reveal key={step.title} delayMs={i * 120}>
              <div className="relative flex h-full flex-col gap-3 rounded-xl border border-[#2a3038] bg-[#10141a] p-6">
              ...
              <Reveal key={item.time} delayMs={i * 100}>
                <div className="flex gap-4">
                  <div className="flex flex-col items-center">
                    ...
                    />
                    {i < timeline.length - 1 && <span className="w-px flex-1 bg-[#2a3038]" />}
                  </div>
                  <div className="pb-8">
      ...
      <section id="faq" className="mx-auto w-full max-w-6xl px-6 py-20">
        <Reveal>
          ...
          <p className="mx-auto mt-3 max-w-xl text-center text-zinc-400">
            More detail on setup and billing:{" "}
            <Link href="/how-it-works" className="text-orange-400 underline underline-offset-4">
              how it works
            </Link>{" "}
            ·{" "}
            <Link href="/pricing" className="text-orange-400 underline underline-offset-4">
              pricing
            </Link>
          </p>
        </Reveal>
